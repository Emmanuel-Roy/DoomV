...
# tools/verification/tests/differential/) from the tools/verification/simulators/spike/src submodule, pinned to a specific
...
echo "Built tools/verification/simulators/spike/spike.exe"
